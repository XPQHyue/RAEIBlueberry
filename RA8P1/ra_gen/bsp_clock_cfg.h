...
#define BSP_CFG_PCLKD_DIV (BSP_CLOCKS_SYS_CLOCK_DIV_8) /* PCLKD Div /8 */
...
#define BSP_CFG_BCLKA_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_MOCO) /* BCLKA Src: MOCO */
...
#define BSP_CFG_SCICLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL1R) /* SCICLK Src: PLL1R */
